package com.amarpatekar.tests;

import com.amarpatekar.listener.TestListener;
...
public abstract class AbstractTest {
    private static final Logger log = (Logger) LoggerFactory.getLogger(AbstractTest.class);
